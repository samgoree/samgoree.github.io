...
It's entirely possible that this take ages poorly. After all, high society used to turn their nose at clothing made in sweatshops as distasteful, but eventually came around to it as companies [aggressively marketed ready-to-wear clothes](https://lithub.com/a-brief-history-of-mass-manufactured-clothing/), making department store fashion a core part of American identity. I view sweatshops as immoral, but I still buy cheap clothes. Often, expensive clothes marketed as bespoke or made to order are still made in sweatshops. I wonder if we'll see the same thing with AI-generated visual culture over the coming years, as things marketed as human-made are increasingly AI.