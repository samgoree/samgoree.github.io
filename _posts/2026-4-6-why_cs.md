...
What hasn't changed:
* There is still as much, if not more need for capable software engineers who are able to understand new and complex problems.
* Our society is still built on top of digital technologies that need to be understood to be maintained.
* Problem solving skills are still one of the most valuable skillsets that employers want, across all kinds of jobs.
