...
excerpt: It's 2026. AI coding tools are everywhere. Large companies are laying off thousands of software engineers. Some people even think that in a few years, no one will need to know how to program computers, as AI tools will allow anyone to create anything they can imagine with a series of English prompts. Why should anyone bother going through the difficult and troublesome process of learning to code today? And why would anyone want to major in computer science if it is not a guaranteed ticket to a high paying job? 
...
I think these concerns are overblown. What has changed:
* There are AI tools that can generate code faster and cheaper than an entry-level software engineer.
* People who are not trained computer scientists can now, with a little trial and error, create correct-looking software.

What hasn't changed:
* There is still as much, if not more need for capable software engineers who are able to understand new and complex problems and design solutions to them.
* Our society is still built on top of digital technologies that needs to be understood to be maintained.
* Problem solving skills are still one of the most valuable things that employers are looking for, across all kinds of jobs.
...
<img src="{{site.baseurl}}/assets/images/tech_enthusiasts.jpg" style="zoom:50%;" />
...
<img src="{{site.baseurl}}/assets/images/soldiers.png"/>
...
<img src="{{site.baseurl}}/assets/images/soldiers_graph.png"/>
...
* **You struggle with math:** Computer science *is* math. We do a lot of routine arithmetic and use a lot of math concepts in our programs. That said, high school math mostly comes into computer science on a conceptual level. We don't spend nearly as much time doing algebra or calculus on paper as much as we spend time thinking mathematically. We also do much less math than enigneers.
...
* **You want an easy path to a high paying job:** I believe that as long as there are computers being used in our society, there will be well-compensated careers for people who understand them. However, that career path is no longer accepting anyone who can complete an undergrad CS degree. A career in tech now requires both interest and skill in addition to knowledge (like almost every other career), as tech companies no longer need to hire as many new grads.
...
This is why I don't think AI means the end of computer science, or the jobs that demand computer science degrees. It may seem, from outside, like software engineers and other people with technical jobs are paid to write code, but they are really paid to solve problems and express the solutions in code. Even if that expression will use an AI system to help fill in the details, the code is merely the artifact indicating a deeper understanding. 

If we end up in a world where people are routinely using AI to build complex systems that we trust to solve important societal problems without a human taking the time to understand those problems, I think we'd have bigger things to worry about than the job market.